...
class TA {
	...
	overload extern inline public static function crossover(prices1:Array<Float>, prices2:Array<Float>):Bool {
	...
	overload extern inline public static function crossover(prices:Array<Float>, value:Float):Bool {
		if (prices.length < 2)
			return false;
		return prices[prices.length - 1] > value && prices[prices.length - 2] < value;
	}

	overload extern inline public static function crossunder(prices1:Array<Float>, prices2:Array<Float>):Bool {
		if (prices1.length < 2 || prices2.length < 2)
			return false;
		return prices1[prices1.length - 1] < prices2[prices2.length - 1] && prices1[prices1.length - 2] > prices2[prices2.length - 2];
	}

	overload extern inline public static function crossunder(prices:Array<Float>, value:Float):Bool {
		if (prices.length < 2)
			return false;
		return prices[prices.length - 1] < value && prices[prices.length - 2] > value;
	}

	overload extern inline public static function cross(prices1:Array<Float>, prices2:Array<Float>):Bool
		return crossover(prices1, prices2) || crossunder(prices1, prices2);

	overload extern inline public static function cross(prices:Array<Float>, value:Float):Bool
